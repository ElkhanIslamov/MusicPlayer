...
const artist_name = ['Qara Qarayev', 'Reşid Behbudov','Şövkət Ələkbərova','Üzeyir Hacibəyov']
const artist_title = ['Yeddi gozel', 'Nazende Sevgilim','Tez Gəl','Arazbari']
